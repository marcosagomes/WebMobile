...
public class ProdutoBean implements Serializable{
  ...
  public ProdutoBean() {
    ...
    List<com.wrm.draftstore.common.entidades.Produto> lista = produtoService.listar(0, 10);
    
    for (com.wrm.draftstore.common.entidades.Produto p : lista) {
      System.out.println("Modelo: "+p.getModelo());
      ofertasSemana.add(p);
    }
    
//    for (int i = 0; i < 5; i++) {
//      ProdutoOld p = new ProdutoOld(i, "(#"+i+") Processador Intel Core i7 3770 3° Geração", null, 1099.0f-i, 1299.0f+i);
//      
